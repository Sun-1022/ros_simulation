...
echo_and_run cd "/home/sun/catkin_ws2/src/tianracer/tianracer_gps"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sun/catkin_ws2/src/tianracer/tianracer_gps/setup.py" \
     \
    build --build-base "/home/sun/catkin_ws2/build/tianracer/tianracer_gps" \
    install \
    --root="${DESTDIR-/}" \
